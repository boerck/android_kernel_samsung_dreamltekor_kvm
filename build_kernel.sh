...
#Samsung Galaxy S8 Korea (dreamltekor) Kernel Build Script by boerck
#SM-G950N

export ANDROID_MAJOR_VERSION=p
export ARCH=arm64
export PATH=${PATH}:scripts/toolchain/gcc-cfp/gcc-cfp-jopp-only/aarch64-linux-android-4.9/bin
